...
if(isset($_POST['remove_job']))
{
    ...
    file_put_contents("job_id.txt",$job_id);
    
    $sql2 ="Delete from job where id = $job_id";
    mysqli_query($conn,$sql2);
...
if(isset($_POST['remove_gig']))
{
    ...
    file_put_contents("gig_id.txt",$gig_id);
   
    
    $sql2 ="Delete from gig where id =$gig_id ";
    mysqli_query($conn,$sql2);
...
if(isset($_POST['review_freelancer']))
{
   ...
   //file_put_contents("test.txt", $rating." ".$comment." ".$client_id." ".$freelancer_id." ".$job_id);
    ...
    $sql = "INSERT INTO rating(rating_from,rating_to,job_id,given_rating,given_review,date) VALUES($client_id,$freelancer_id,$job_id,$rating,'$comment','$date')";
    mysqli_query($conn,$sql);
...
if(isset($_POST['review_client']))
{
   ...
   //file_put_contents("test.txt", $rating." ".$comment." ".$client_id." ".$freelancer_id." ".$job_id);
    ...
    $sql = "INSERT INTO rating(rating_from,rating_to,job_id,given_rating,given_review,date) VALUES($freelancer_id,$client_id,$job_id,$rating,'$comment','$date')";
    mysqli_query($conn,$sql);
