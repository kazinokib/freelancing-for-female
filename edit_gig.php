		...
		<div class="dashboard-content-container" data-simplebar>
			<div class="dashboard-content-inner" >
				...
				<div class="row">
								...
								<div class="row">
									...
									<div class="col-xl-4">
										<div class="submit-field">
											<h5>Title</h5>
											<input id = "gig_title" type="text" class="with-border" value = "<?php echo $row["gig_title"] ?>">
										</div>
									</div>
									...
									<div class="col-xl-4">
										<div class="submit-field">
											...
											<div class="row">
												<div class="col-xl-6">
													<div class="input-with-icon">
														<input id = "duration" class="with-border" type="text" placeholder="Minimum Duration" value = "<?php echo $row["gig_duration"]  ?>">
									...
									<div class="col-xl-12">
										<div class="submit-field">
											...
											<textarea id = 'gig_description' cols="30" rows="5" class="with-border"><?php echo $row['gig_description'] ?></textarea>
					...
					<div class="col-xl-12">
						<a href="#" onclick="update_gig(<?php $row["id"]?>)" class="button ripple-effect big margin-top-30"><i class="icon-feather-plus"></i>Update</a>
					</div>
