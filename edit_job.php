		...
		<div class="dashboard-content-container" data-simplebar>
			<div class="dashboard-content-inner" >
				...
				<div class="row">
								...
								<div class="row">
									...
									<div class="col-xl-4">
										<div class="submit-field">
											<h5>Title</h5>
											<input id = "job_title" type="text" class="with-border" value ="<?php echo $row["job_title"] ?>">
										</div>
									</div>
									...
									<div class="col-xl-4">
										<div class="submit-field">
											<h5>Category</h5>
											<select  id = "job_category" class="selectpicker with-border" data-size="7" title="Select Category"  value ="<?php echo $row["job_category"] ?>">
									...
									<div class="col-xl-4">
										<div class="submit-field">
											...
											<div class="row">
												<div class="col-xl-6">
													<div class="input-with-icon">
														<input id = "job_duration" class="with-border" type="text" placeholder="Duration"  value ="<?php echo $row["job_duration"] ?>">
									...
									<div class="col-xl-12">
										<div class="submit-field">
											...
											<textarea id = 'job_description' cols="30" rows="5" class="with-border"><?php echo $row["job_description"] ?></textarea>
					...
					<div class="col-xl-12">
						<a href="#" onclick="update_job(<?php echo $row["id"] ?>)" class="button ripple-effect big margin-top-30"><i class="icon-feather-plus"></i> Update</a>
					</div>
