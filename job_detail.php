		...
		<div class="row">
			<div class="col-md-12">
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image"><a href="#"><img src="<?php echo $job_file ?>" alt=""></a></div>
	...
	<div class="row">
				...
				<div class="col-md-4 col-sm-6">
											<article class="destination-box style-1">
												...
												<div class="destination-box-image">
													<figure>
														<a data-fancybox="gallery" href="<?php echo $job_file ?>">
															<img src="<?php echo $job_file ?>" class="img-responsive listing-box-img" alt="" />
		...
		<div class="col-xl-4 col-lg-4">
			<div class="sidebar-container">
				...
				<div class="countdown green margin-bottom-35"><?php echo $remaining_day ?> days left</div>
...
<script type="text/javascript">
    ...
    formData.append('bid_rate',bid_rate);
    formData.append("bid_duration",bid_duration);
